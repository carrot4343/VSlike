...
public class Equipment 
{
    ...
    public Equipment(string key)
    {
        ...
        EquipmentData = Managers._Data.EquipDataDic[key];
    ...
    public void ResetEquipLevel()
    {
        ...
        {
            Level--;
            receiveGold += Managers._Data.EquipLevelDataDic[Level].UpgradeCost;//LevelUpCost.UpgradCost;
            receiveMaterial += Managers._Data.EquipLevelDataDic[Level].UpgradeRequiredItems;
        }
        
        Managers._Game.Gold += receiveGold;
